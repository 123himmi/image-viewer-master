...
export default class Profile extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({ response: mediaData.data });
    this.setState({ fullName: "Himanshi.k" });
  }
  openModal = () => {
  ...
  render() {
    ...
    return (
      <div className="profile-wrapper">
        <Header url={UpgradImage} homepageHeader={true} goToHome={true} />
        <div className="information-section">
          <Avatar aria-label="recipe">
            <img src={UpgradImage} alt="profile-pic" className="profile-pic" />
          </Avatar>
          <div className="user-info">
            <p className="username">{"Upgrad_sde"}</p>
